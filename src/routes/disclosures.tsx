...
export const Route = createFileRoute("/disclosures")({
  head: () => ({
    meta: [
      { title: "Disclosures — Verdant Capital" },
      { name: "description", content: "Regulatory disclosures, risk warnings, and conflict-of-interest policies for Verdant Capital." },
      { property: "og:title", content: "Disclosures — Verdant" },
  ...
  component: () => (
    ...
    >
      <Prose sections={[
        ...
        { h: "Conflicts of interest", p: "Verdant Capital and its affiliates may, from time to time, have positions in instruments mentioned. We maintain written policies to identify, manage, and disclose conflicts of interest. A full copy of our conflicts policy is available on request." },
        { h: "Regulation", p: "Verdant Capital, Inc. is registered with the U.S. Securities and Exchange Commission (SEC) and is a member of FINRA and SIPC. Verdant Capital UK Ltd is authorised and regulated by the Financial Conduct Authority (FCA). Verdant Capital EU is regulated by BaFin." },
      ]} />
    </PageShell>
  ),
});
