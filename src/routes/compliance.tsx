...
export const Route = createFileRoute("/compliance")({
  head: () => ({
    meta: [
      { title: "Compliance — Solynvest" },
      { name: "description", content: "Solynvest's regulatory licences, compliance programme, and AML/KYC policies." },
      { property: "og:title", content: "Compliance — Solynvest" },
  ...
  component: () => (
    <PageShell
      ...
      lead="Solynvest operates under regulated entities in the United States, United Kingdom, and European Union."
    >
      <Prose sections={[
        { h: "Licences & registrations", p: "Solynvest, Inc. — SEC Registered Investment Adviser (CRD #312478), FINRA member, SIPC member.\nSolynvest UK Ltd — Authorised and regulated by the Financial Conduct Authority (FRN 924818).\nSolynvest EU GmbH — Regulated by BaFin (Reg. 154-789-22)." },
        ...
        { h: "Client asset protection", p: "Client funds are held with regulated custodian banks, segregated from Solynvest's own assets. U.S. brokerage accounts are protected by SIPC up to $500,000 (including $250,000 cash). Additional excess-of-SIPC coverage is provided through Lloyd's of London." },
